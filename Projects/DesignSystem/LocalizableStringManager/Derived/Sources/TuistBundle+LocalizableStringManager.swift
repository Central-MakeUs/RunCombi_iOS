...
/// Since LocalizableStringManager is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "LocalizableStringManager_LocalizableStringManager"
    ...
    fatalError("unable to find bundle named LocalizableStringManager_LocalizableStringManager")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class LocalizableStringManagerResources: NSObject {
