...
/// Since UserInterface is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "UserInterface_UserInterface"
    ...
    fatalError("unable to find bundle named UserInterface_UserInterface")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class UserInterfaceResources: NSObject {
